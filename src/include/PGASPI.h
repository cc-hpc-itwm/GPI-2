...
#include "GASPI.h"
  ...
  gaspi_return_t pgaspi_atomic_fetch_add (const gaspi_segment_id_t segment_id,
                                          ...
                                          const gaspi_timeout_t timeout_ms);
  gaspi_return_t pgaspi_atomic_compare_swap (const gaspi_segment_id_t segment_id,
                                             const gaspi_offset_t offset,
                                             const gaspi_rank_t rank,
  ...
  gaspi_return_t pgaspi_passive_send (const gaspi_segment_id_t segment_id_local,
                                      const gaspi_offset_t offset_local,
                                      const gaspi_rank_t rank,
                                      const gaspi_size_t size,
                                      const gaspi_timeout_t timeout_ms);
  ...
  gaspi_return_t pgaspi_notify_waitsome (const gaspi_segment_id_t segment_id_local,
                                         const gaspi_notification_id_t notification_begin,
                                         const gaspi_number_t num,
                                         gaspi_notification_id_t * const first_id,
                                         const gaspi_timeout_t timeout_ms);

  gaspi_return_t pgaspi_notify_reset (const gaspi_segment_id_t segment_id_local,
